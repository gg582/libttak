...
SRC_DIRS = src/ht src/thread src/timing src/mem src/async src/priority src/atomic src/sync src/math src/tree src/container src/security src/mem_tree src/limit src/stats src/log
